 ...
 */
export function graphql(
	source: "fragment Collection on Collection {\n  id\n  name\n  description\n  slug\n}",
 ...
 */
export function graphql(
	source: "fragment ProductsListItem on Product {\n  id\n  slug\n  name\n  rating\n  price\n  categories {\n    edges {\n      node {\n        name\n      }\n    }\n  }\n  images {\n    edges {\n      node {\n        url\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "mutation cartAddItem($cartId: ID!, $productId: ID!, $quantity: Int!) {\n  cartAddItem(input: {id: $cartId, productId: $productId, quantity: $quantity}) {\n    cart {\n      id\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "mutation CartComplete($cartId: ID!, $userEmail: String!) {\n  cartComplete(input: {id: $cartId, userEmail: $userEmail}) {\n    cart {\n      id\n      status\n    }\n  }\n}",
): typeof import("./graphql").CartCompleteDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "mutation CartFindOrCreate($id: ID) {\n  cartFindOrCreate(input: {id: $id}) {\n    cart {\n      id\n      items {\n        edges {\n          node {\n            product {\n              id\n              name\n              price\n              images {\n                edges {\n                  node {\n                    url\n                    alt\n                  }\n                }\n              }\n            }\n            quantity\n          }\n        }\n      }\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "mutation ReviewCreate($author: String!, $description: String!, $email: String!, $productId: ID!, $rating: Int!, $title: String!) {\n  reviewCreate(\n    input: {author: $author, description: $description, email: $email, productId: $productId, rating: $rating, title: $title}\n  ) {\n    review {\n      id\n    }\n  }\n}",
 ...
 */
export function graphql(
	source: "query ProductGetById($slug: String!) {\n  product(slug: $slug) {\n    ...Product\n  }\n}",
): typeof import("./graphql").ProductGetByIdDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetByCategorySlug($first: Int, $skip: Int, $slug: String) {\n  category(slug: $slug) {\n    name\n    products(first: $first, skip: $skip) {\n      totalCount\n      edges {\n        node {\n          ...ProductsListItem\n        }\n      }\n    }\n  }\n}",
): typeof import("./graphql").ProductsGetByCategorySlugDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetByCollectionSlug($slug: String) {\n  collection(slug: $slug) {\n    id\n    name\n    products {\n      totalCount\n      edges {\n        node {\n          ...ProductsListItem\n        }\n      }\n    }\n  }\n}",
): typeof import("./graphql").ProductsGetByCollectionSlugDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetList($first: Int, $skip: Int, $order: SortDirection, $orderBy: ProductSortBy) {\n  products(first: $first, skip: $skip, order: $order, orderBy: $orderBy) {\n    totalCount\n    edges {\n      node {\n        ...ProductsListItem\n      }\n    }\n  }\n}",
): typeof import("./graphql").ProductsGetListDocument;
/**
 * The graphql function is used to parse GraphQL queries into a document that can be used by GraphQL clients.
 */
export function graphql(
	source: "query ProductsGetListBySearch($first: Int, $skip: Int, $search: String, $order: SortDirection, $orderBy: ProductSortBy) {\n  products(\n    first: $first\n    skip: $skip\n    search: $search\n    order: $order\n    orderBy: $orderBy\n  ) {\n    totalCount\n    edges {\n      node {\n        ...ProductsListItem\n      }\n    }\n  }\n}",
