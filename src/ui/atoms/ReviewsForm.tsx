...
export const ReviewsForm = ({
	...
	return (
		<form data-testid="add-review-form" className="mx-auto flex w-full flex-col gap-4 " ref={formRef}>
			<input
				type="text"
				name="headline"
				id="headline"
			...
			<button
				...
				formAction={async (formData) => {
					const { email, rating, headline, content, name } = Object.fromEntries(formData) as ReviewType;
